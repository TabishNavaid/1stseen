...
import { parseAuthFragment } from "@/lib/auth/policy";
...
type Failure = "link_unusable" | "link_invalid" | "unavailable";
...
export function ConfirmEmail() {
  ...
  const shown: Failure | null = fragment !== null && !link ? "link_invalid" : failure;
