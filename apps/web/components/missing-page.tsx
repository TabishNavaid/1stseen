        ...
        <IllustratedMessage
          ...
          primary={
            company
              ...
              : <Link href="/roles" className={primaryActionClass}>Browse all roles</Link>
          }
          secondary={company ? <Link href="/roles" className={quietLinkClass}>or browse all roles</Link> : <Link href="/" className={quietLinkClass}>or go home</Link>}
        />
      ) : (
        <IllustratedMessage
          art={ILLUSTRATIONS[art]}
          ...
          secondary={<Link href="/roles" className={quietLinkClass}>or browse all roles</Link>}
        />
      )}
    </main>
  );
